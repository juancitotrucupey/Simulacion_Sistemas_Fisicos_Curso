...
const double Lx=100;
const double Ly=100;
const int N=1; //número de Granos
//............................
class Cuerpo;
class Colisionador;
//............................
...
int main(void){
  ...
  double t,dt=0.001;
  double tdibujo,tmax, ndibujos=5000;
  double R0=3, m0=1;
  double T,VEL0=10,Alpha=M_PI/6,dx,dy;
  ...
  //der
   ...
   // abajo
   Grano[N+2].Inicie(Lx/2,-10000,0,0,0,0,1,10000);//Sol
   // arriba
   Grano[N+3].Inicie(Lx/2,Ly+10000,0,0,0,0,1,10000);//Sol
...
// Planeta[1].Inicie(x1,0,0,0,V1,0,m1,1);//Tierra
  ...
  //------------(x0,y0,Vx0,Vy0,m0   ,R0);
	for(t=0,tdibujo=0;t<tmax;t+=dt,tdibujo+=dt){
		//cout<<Grano[i].Getx()<<" "<<Grano[i].Gety()<<endl;
		//Animacion
