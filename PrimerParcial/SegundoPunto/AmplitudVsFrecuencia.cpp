...
double AmplitudVsFrecuencia(double Omega){
...
for(i=0;i<N;i++)Oscilador[i].InicieMaxMin();
...
return Oscilador[1].GetAmplitud();
}

int main(void){
double Omega;
for(Omega=0.1;Omega<3.0;Omega+=0.01)
{cout<<Omega<<" "<<AmplitudVsFrecuencia(Omega)<<endl;
}
  return 0;
}
