...
const double GM=1.0;
const double CHI   =0.1644986515575760;
const double LAMBDA=-0.02094333910398989;
const double XI    =1.235692651138917;
...
int main(void){
  ...
  for(t=0,tdibujo=0;t<tmax;t+=Deltat,tdibujo+=Deltat){
    ...
    */
    ...
    Planeta.Mueva_r(Deltat,uno_m2LAMBDA_S2);
    Planeta.CalculeFuerza(); Planeta.Mueva_V(Deltat,XI); 
    Planeta.Mueva_r(Deltat,LAMBDA);
    Planeta.CalculeFuerza(); Planeta.Mueva_V(Deltat,uno_m2_XIplusCHI); 
    Planeta.Mueva_r(Deltat,LAMBDA);
    Planeta.CalculeFuerza(); Planeta.Mueva_V(Deltat,XI); 
    Planeta.Mueva_r(Deltat,uno_m2LAMBDA_S2);
    Planeta.CalculeFuerza(); Planeta.Mueva_V(Deltat,CHI);
