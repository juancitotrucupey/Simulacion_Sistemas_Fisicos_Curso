...
{
  double fa=Descache(a),fb=Descache(b);
  double m,fm;
...
int main(void){
  ...
  cout<<"ingrese el limite superior de Omega ";cin>>b;
  cout<<"ingrese el limite inferior de Omega ";cin>>a;

  cout<<"el valor del cero es "<<CeroPorBiseccion(a,b)<<endl;
